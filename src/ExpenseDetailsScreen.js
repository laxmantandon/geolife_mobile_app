import { View, Text, TextInput, StyleSheet, Button, PermissionsAndroid, Image, Pressable } from 'react-native'
...
const ExpenseDetailsScreen = ({item}) => {
  const [expense_type, setexpense_type] = useState(["Option 01", "Option 02", "Option 03", "Option 04"])
  ...
  return (
    <View style={{flex:1, backgroundColor:'white'}}>
      <View style={styles.inputbox}>
          <Text style={{ fontSize: 15}}>Amount Against Expense</Text>
      ...
      <View style={{ paddingBottom: 20, paddingLeft: 10 }}>
          ...
          <TextInput placeholder="Note about expanse" multiline={true} numberOfLines={6} 
          onChangeText={(val)=>{setnote(val)}} style={styles.InputStyle} />
      </View>
